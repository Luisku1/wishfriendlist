...
function getFollowedUsers(req, res)
{
    ...
    Follow.find({user: userId}).populate('user').paginate(page, itemsPerPage, (err, follows, total) =>{
...
//Devolver listados de usuarios que tienen relación conmigo en cuanto a follows
